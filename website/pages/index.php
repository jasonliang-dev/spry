...
<div class="mw8 center pt3 mb5">
  ...
  <a class="mb2 mr2 bg-blue white ba b--black-10 br2 ph3 pv2 link underline-hover inline-flex items-center" href="quick-start.html">
    Get started with Spry
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="20" height="20">
      <path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
    </svg>
  </a>
  <a class="mb2 bg-white dm-bg-black black dm-white ba b--black-20 dm-b--white-20 br2 ph3 pv2 link underline-hover inline-flex items-center" href="https://github.com/jasonliang-dev/spry">
    View on GitHub
...
<div class="mw8 center mt5">
  ...
  <a class="bg-blue white ba b--black-10 br2 ph3 pv2 link underline-hover inline-flex items-center" href="quick-start.html">
