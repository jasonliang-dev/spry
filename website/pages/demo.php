<div class="flex flex-column items-center center" style="width: <?= $page["width"] ?>px">
  <div class="prose w-100">
    <h1><?= $page["title"] ?></h1>
    <?= Parsedown::instance()->text(multiline_trim($page["text"])) ?>
  </div>
  <canvas
  ...
  <div class="mt3 flex justify-between w-100">
    ...
    <a class="blue link underline-hover inline-flex items-center" href="<?= $page["source"] ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24">
