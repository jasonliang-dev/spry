...
inline mu_Rect mu_atlas_lookup(int n) {
  switch (n) {
  case MU_ICON_CLOSE: return {88, 68, 16, 16};
  case MU_ICON_CHECK: return {0, 0, 18, 18};
  case MU_ICON_EXPANDED: return {118, 68, 7, 5};
  case MU_ICON_COLLAPSED: return {113, 68, 5, 7};
  case MU_ATLAS_WHITE: return {125, 68, 3, 3};
  case MU_ATLAS_FONT + 32: return {84, 68, 2, 17};
  case MU_ATLAS_FONT + 33: return {39, 68, 3, 17};
  case MU_ATLAS_FONT + 34: return {114, 51, 5, 17};
  case MU_ATLAS_FONT + 35: return {34, 17, 7, 17};
  case MU_ATLAS_FONT + 36: return {28, 34, 6, 17};
  case MU_ATLAS_FONT + 37: return {58, 0, 9, 17};
  case MU_ATLAS_FONT + 38: return {103, 0, 8, 17};
  case MU_ATLAS_FONT + 39: return {86, 68, 2, 17};
  case MU_ATLAS_FONT + 40: return {42, 68, 3, 17};
  case MU_ATLAS_FONT + 41: return {45, 68, 3, 17};
  case MU_ATLAS_FONT + 42: return {34, 34, 6, 17};
  case MU_ATLAS_FONT + 43: return {40, 34, 6, 17};
  case MU_ATLAS_FONT + 44: return {48, 68, 3, 17};
  case MU_ATLAS_FONT + 45: return {51, 68, 3, 17};
  case MU_ATLAS_FONT + 46: return {54, 68, 3, 17};
  case MU_ATLAS_FONT + 47: return {124, 34, 4, 17};
  case MU_ATLAS_FONT + 48: return {46, 34, 6, 17};
  case MU_ATLAS_FONT + 49: return {52, 34, 6, 17};
  case MU_ATLAS_FONT + 50: return {58, 34, 6, 17};
  case MU_ATLAS_FONT + 51: return {64, 34, 6, 17};
  case MU_ATLAS_FONT + 52: return {70, 34, 6, 17};
  case MU_ATLAS_FONT + 53: return {76, 34, 6, 17};
  case MU_ATLAS_FONT + 54: return {82, 34, 6, 17};
  case MU_ATLAS_FONT + 55: return {88, 34, 6, 17};
  case MU_ATLAS_FONT + 56: return {94, 34, 6, 17};
  case MU_ATLAS_FONT + 57: return {100, 34, 6, 17};
  case MU_ATLAS_FONT + 58: return {57, 68, 3, 17};
  case MU_ATLAS_FONT + 59: return {60, 68, 3, 17};
  case MU_ATLAS_FONT + 60: return {106, 34, 6, 17};
  case MU_ATLAS_FONT + 61: return {112, 34, 6, 17};
  case MU_ATLAS_FONT + 62: return {118, 34, 6, 17};
  case MU_ATLAS_FONT + 63: return {119, 51, 5, 17};
  case MU_ATLAS_FONT + 64: return {18, 0, 10, 17};
  case MU_ATLAS_FONT + 65: return {41, 17, 7, 17};
  case MU_ATLAS_FONT + 66: return {48, 17, 7, 17};
  case MU_ATLAS_FONT + 67: return {55, 17, 7, 17};
  case MU_ATLAS_FONT + 68: return {111, 0, 8, 17};
  case MU_ATLAS_FONT + 69: return {0, 35, 6, 17};
  case MU_ATLAS_FONT + 70: return {6, 35, 6, 17};
  case MU_ATLAS_FONT + 71: return {119, 0, 8, 17};
  case MU_ATLAS_FONT + 72: return {18, 17, 8, 17};
  case MU_ATLAS_FONT + 73: return {63, 68, 3, 17};
  case MU_ATLAS_FONT + 74: return {66, 68, 3, 17};
  case MU_ATLAS_FONT + 75: return {62, 17, 7, 17};
  case MU_ATLAS_FONT + 76: return {12, 51, 6, 17};
  case MU_ATLAS_FONT + 77: return {28, 0, 10, 17};
  case MU_ATLAS_FONT + 78: return {67, 0, 9, 17};
  case MU_ATLAS_FONT + 79: return {76, 0, 9, 17};
  case MU_ATLAS_FONT + 80: return {69, 17, 7, 17};
  case MU_ATLAS_FONT + 81: return {85, 0, 9, 17};
  case MU_ATLAS_FONT + 82: return {76, 17, 7, 17};
  case MU_ATLAS_FONT + 83: return {18, 51, 6, 17};
  case MU_ATLAS_FONT + 84: return {24, 51, 6, 17};
  case MU_ATLAS_FONT + 85: return {26, 17, 8, 17};
  case MU_ATLAS_FONT + 86: return {83, 17, 7, 17};
  case MU_ATLAS_FONT + 87: return {38, 0, 10, 17};
  case MU_ATLAS_FONT + 88: return {90, 17, 7, 17};
  case MU_ATLAS_FONT + 89: return {30, 51, 6, 17};
  case MU_ATLAS_FONT + 90: return {36, 51, 6, 17};
  case MU_ATLAS_FONT + 91: return {69, 68, 3, 17};
  case MU_ATLAS_FONT + 92: return {124, 51, 4, 17};
  case MU_ATLAS_FONT + 93: return {72, 68, 3, 17};
  case MU_ATLAS_FONT + 94: return {42, 51, 6, 17};
  case MU_ATLAS_FONT + 95: return {15, 68, 4, 17};
  case MU_ATLAS_FONT + 96: return {48, 51, 6, 17};
  case MU_ATLAS_FONT + 97: return {54, 51, 6, 17};
  case MU_ATLAS_FONT + 98: return {97, 17, 7, 17};
  case MU_ATLAS_FONT + 99: return {0, 52, 5, 17};
  case MU_ATLAS_FONT + 100: return {104, 17, 7, 17};
  case MU_ATLAS_FONT + 101: return {60, 51, 6, 17};
  case MU_ATLAS_FONT + 102: return {19, 68, 4, 17};
  case MU_ATLAS_FONT + 103: return {66, 51, 6, 17};
  case MU_ATLAS_FONT + 104: return {111, 17, 7, 17};
  case MU_ATLAS_FONT + 105: return {75, 68, 3, 17};
  case MU_ATLAS_FONT + 106: return {78, 68, 3, 17};
  case MU_ATLAS_FONT + 107: return {72, 51, 6, 17};
  case MU_ATLAS_FONT + 108: return {81, 68, 3, 17};
  case MU_ATLAS_FONT + 109: return {48, 0, 10, 17};
  case MU_ATLAS_FONT + 110: return {118, 17, 7, 17};
  case MU_ATLAS_FONT + 111: return {0, 18, 7, 17};
  case MU_ATLAS_FONT + 112: return {7, 18, 7, 17};
  case MU_ATLAS_FONT + 113: return {14, 34, 7, 17};
  case MU_ATLAS_FONT + 114: return {23, 68, 4, 17};
  case MU_ATLAS_FONT + 115: return {5, 52, 5, 17};
  case MU_ATLAS_FONT + 116: return {27, 68, 4, 17};
  case MU_ATLAS_FONT + 117: return {21, 34, 7, 17};
  case MU_ATLAS_FONT + 118: return {78, 51, 6, 17};
  case MU_ATLAS_FONT + 119: return {94, 0, 9, 17};
  case MU_ATLAS_FONT + 120: return {84, 51, 6, 17};
  case MU_ATLAS_FONT + 121: return {90, 51, 6, 17};
  case MU_ATLAS_FONT + 122: return {10, 68, 5, 17};
  case MU_ATLAS_FONT + 123: return {31, 68, 4, 17};
  case MU_ATLAS_FONT + 124: return {96, 51, 6, 17};
  case MU_ATLAS_FONT + 125: return {35, 68, 4, 17};
  case MU_ATLAS_FONT + 126: return {102, 51, 6, 17};
  case MU_ATLAS_FONT + 127: return {108, 51, 6, 17};
  default: return {};
  }
}
