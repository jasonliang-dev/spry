...
if [ "$1" = "web_release" ]; then
  emcc -Wall -O2 -DRELEASE -Isrc/deps/box2d src/spry.cpp -o spry.js -lpthread -sASYNCIFY -sNO_DISABLE_EXCEPTION_CATCHING
elif [ "$1" = "web" ]; then
  emcc -Wall -DDEBUG -Isrc/deps/box2d src/spry.cpp -o spry.js -lpthread -sASYNCIFY -sNO_DISABLE_EXCEPTION_CATCHING
elif [ "$1" = "release" ]; then
